...
class CamVidVideoDataset(CustomDataset):
    """Cityscapes dataset.
    The ``img_suffix`` is fixed to '_leftImg8bit.png' and ``seg_map_suffix`` is
    fixed to '_gtFine_labelTrainIds.png' for Cityscapes dataset.
    """

    CLASSES = ('void', 'sky', 'building', 'column_pole', 'road',
    ...
    def __init__(self, img_suffix='.png',
            seg_map_suffix='_L.png', **kwargs):
        super(CamVidVideoDataset, self).__init__(
