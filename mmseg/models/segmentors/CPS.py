...
class CpsEncoderDecoder(BaseSegmentor):
    """CPS semi-supervised Encoder Decoder segmentors.

    CPS semi-supervisied model has two branches,each branch is almost the same as EncoderDecoder. 
    This is based on [CVPR 2021] Semi-Supervised Semantic Segmentation with Cross Pseudo Supervision
    """
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(CpsEncoderDecoder, self).__init__(
            backbone=backbone,
